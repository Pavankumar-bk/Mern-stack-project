...
const MyApplications = () => {
  ...
  // Redirecting to home if not authorized
  if (!isAuthorized) {
    navigateTo("/");
  }
  ...
  // Function to open modal with resume image
  ...
  // Rendering UI based on user's role
  return (
    ...
    <>
      <div className="job_seeker_card">
        ...
        <div className="resume">
          {/* Displaying resume image and attaching open modal function */}
          <img
